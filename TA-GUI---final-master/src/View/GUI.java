...
public class GUI {
    ...
    public GUI() {
        ...
        top = new JLabel("Rumah Sakit Rusak Jaya Abadi");
        ...
        check.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (ceklogin == true) {
                    try {
                        Allobjctrl.doktor.dataDokter();
                        Allobjctrl.doktor.login(textnpmlogin.getText(), passwordlogin.getText());
                        String nama = Allobjctrl.doktor.DokterEntity().getNama();
                        JOptionPane.showMessageDialog(null, "selamat datang " + nama, "information", JOptionPane.INFORMATION_MESSAGE);
                        DokterGUI Dokter = new DokterGUI();
                        LogReg.dispose();
                    } catch (Exception exception) {
                        JOptionPane.showMessageDialog(
                                null, "Nik atau password salah", "information", JOptionPane.INFORMATION_MESSAGE);
                        kosong();
                    }
                } else {
                    try {
                        Allobjctrl.Pasien.login(textnpmlogin.getText(), passwordlogin.getText());
                        String nama = Allobjctrl.Pasien.PasienEntity().getNama();
                        JOptionPane.showMessageDialog(null, "Selamat Datang " + nama, "information", JOptionPane.INFORMATION_MESSAGE);
                        PasienGUI prak = new PasienGUI();
                        LogReg.dispose();
                    } catch (Exception exception) {
        ...
        reg.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    String Nik = textnpmdaftar.getText();
                    ...
                    Allobjctrl.Pasien.insert(Nik, pass, nama, notelp, tgllahir, kelas);
